using Oculus.Haptics;//Somewhat dated, newwer libraries are meta
...
public class Bow : MonoBehaviour
{
    ...
    [Header("Haptics")]
    public HapticClipPlayer hapticClipPlayer; //referencing hptic library
    [Header("Audio")]
    public AudioClip bowReleaseSound;
    public AudioSource bowAudioSoucre;
    private void Awake()
    {
        m_Animator = GetComponent<Animator>();
        bowAudioSoucre = GetComponent<AudioSource>();
    }
    ...
    private void PlayHapticFeedback()
    {
        ...
        if (bowAudioSoucre != null && bowReleaseSound != null) 
        { 
            bowAudioSoucre.PlayOneShot(bowReleaseSound);
        }
    }
}
